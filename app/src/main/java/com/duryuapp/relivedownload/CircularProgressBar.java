...
public class CircularProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        initMeasurments();
        drawOutlineArc(canvas, 360, mProgressBackColor);
        drawOutlineArc(canvas, mSweepAngle, mProgressColor);
    ...
    private void drawOutlineArc(Canvas canvas, float angle, int color) {
        ...
        canvas.drawArc(outerOval, mStartAngle, angle, false, mPaint);
    }
    ...
    public void setProgress(int progress) {
        ...
        */
        ...
        mSweepAngle = (float) calcSweepAngleFromProgress(progress);
        invalidate();
    }
